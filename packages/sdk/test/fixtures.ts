 ...
 * The CRS bundle is witness-gen-independent: `witness_gen.wasm` ships in its own
 * channel (see `downloadWitnessGen`) and is NOT part of the release manifest.
 */
...
export interface Release {
  /** Artifact name -> file bytes (the 6 CRS release artifacts, no witness_gen). */
